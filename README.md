...
**Indexace a cache:** Při otevření databáze se nejdřív indexuje okolí GPS (~4 km), poté běží **plná indexace na pozadí** s diskovou cache podle otisku obsahu souboru (aktuálně formát cache **v21**). Po restartu aplikace se index znovu načte během desítek sekund. Podrobnosti: [`docs/INDEXACE_DZS.md`](docs/INDEXACE_DZS.md).
...
│  ├─ DzsIndexCache.java       – disková cache indexů (gzip .idx, verze 21)
...
| [`docs/INDEXACE_DZS.md`](docs/INDEXACE_DZS.md) | Technický popis indexace DZS, formát cache `.idx`, řešení problémů |
