...
| Nápověda čipu | u 3částových výhybek volba **Jazyk / Rovně / Odbočka**; u 4částových konkrétní kódy z DB (CA/CB, CG/CH, …) |
...
|-----|-----------------|------|---------------|
| 3částová | `POLOHA` začíná **J** | 1–3 | jazyk, rovně, odbočka (volba u každého čipu) |
...
Zápis tagu na hranici dvou úseků tratě – viz **příručka pro terén** ([`docs/RFID_Go_GPS_prirucka_teren.pdf`](docs/RFID_Go_GPS_prirucka_teren.pdf)), kapitola 7.
...
| [`docs/RFID_Go_GPS_prirucka_vyvojare.pdf`](docs/RFID_Go_GPS_prirucka_vyvojare.pdf) | **Technická příručka pro vývojáře** – architektura, třídy, datové toky, kód |
...
| [`docs/prirucka-vyvojare.md`](docs/prirucka-vyvojare.md) | Zdroj technické příručky; PDF: `python3 docs/generate_prirucka_vyvojare.py` |
